...
import banner_img from '../../images/IMG2.jpg';
import luxuryimg from '../../images/ArchImg5.jpg';
...
const High = () => {
    ...
    return (
        <div className='p-4 sm:p-6 lg:py-12'>
            ...
            <div className='flex flex-col lg:h-[80%] md:h-[500px] px-3 lg:flex-row md:flex-row gap-10'>
                {/* Image Section */}
                <div className='w-full lg:w-[60%] md:w-[60%]  bg-slate-500'>
                    <img src={luxuryimg} alt="Project" className='  bg-cover w-full bg-center  lg:h-[480px] md:h-full h-[260px] ' />
                </div>

                {/* Details Section */}
                <div className='w-full lg:w-[40%] md:w-[40%] border-2 flex flex-col gap-1 border-gray-300 rounded-md lg:p-4 md:px-3 p-3 lg:py-1 md:py-10' >
                    {detail.map((item, index) => (
                        <div key={index} className='flex justify-between items-center py-1 px-6'>
                    ...
                    <div className='flex items-center justify-center mt-6'>
                        <IoMailOpenOutline className='text-orange-600 text-lg mr-' />
                    ...
                    <div className='flex justify-center mb-5 lg:mt-4 '>
                        <button className='text-black border-2 border-orange-600 hover:bg-orange-600  hover:text-white px-6 py-2 rounded'>
                            Get Contact
                        </button>
                    </div>
                </div>
            ...
            <div className='flex flex-col lg:items-start lg:flex-row w-full gap-8 mt-8'>
                <div className='w-full lg:w-[30%] border-2 p-4 border-red-300'>
                    <div>
                        ...
                        <p className='p-2 font-light text-sm sm:text-base text-justify'>
                ...
                <div className='w-full lg:w-[68%] bg-orange-200 p-4 h-fit'>
                    ...
                    >
                        <div className="bg-white bg-opacity-80 p-6 sm:p-8 rounded-lg text-center max-w-md mx-auto">
                            <h2 className="text-2xl sm:text-3xl font-bold text-orange-600 mb-4">Build To Future</h2>
                    ...
                    <div className='mb-4'>
                        <h2 className='text-center text-xl font-bold pt-1'>Our Works</h2>
                        <div className='flex flex-wrap gap-1 justify-evenly lg:px-1 px-5 py-2'>
        {pro_img.map((item, index) => (
            <img 
                key={index} 
                className=' mt-3 bg-cover bg-center h-[100px] lg:w-40 w-[45%] sm:h-[150px] rounded-md' 
                src={item.img} 
                alt={`Work ${index + 1}`} 
            />
        ))}
    </div>
                        {/* <div className='flex flex-wrap gap-1 justify-evenly lg:px-2 px-5 py-2'>
                            { pro_img.map((item,index) => {
                                  <img key={index} className=' mt-3 bg-cover bg-center h-[100px] lg:w-40 w-[45%] sm:h-[150px] rounded-md' src={item.img} alt="Work 2" />
                            })}

                        </div> */}
                          {/* <img className=' mt-3 bg-cover bg-center h-[100px] lg:w-40 w-[45%] sm:h-[150px] rounded-md' src={banner_img} alt="Work 2" />
                            <img className=' mt-3 bg-cover bg-center h-[100px] lg:w-40 w-[45%] sm:h-[150px] rounded-md' src={banner_img} alt="Work 2" />
                            <img className=' mt-3 bg-cover bg-center h-[100px] lg:w-40 w-[45%] sm:h-[150px] rounded-md' src={banner_img} alt="Work 2" />
                            <img className=' mt-3 bg-cover bg-center h-[100px] lg:w-40 w-[45%] sm:h-[150px] rounded-md' src={banner_img} alt="Work 2" /> */}
                    </div>

                    <div className='px-2 py-4 lg:px-6  bg-white'>
                        <h1 className='text-lg font-semibold py-0.5 px-2'>Services Offered</h1>
                        <div>
                            {list.map((item, index) => (
                                <div key={index} className='flex items-center gap-2 px-2 py-1'>
                                    <MdDoubleArrow className='text-orange-600
                                    lg:size-7 md:size-3 size-10'  />
