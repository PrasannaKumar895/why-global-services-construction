    ...
    return (
        <div className='flex flex-col md:flex-row items-center justify-center bg-white py-20 px-6 md:px-12 lg:px-24'>
            ...
            <div className='flex flex-col gap-3 w-full md:w-1/2 mb-8 md:mb-0 md:pr-8'>
                <h2 className='text-xl md:text-2xl lg:text-[2rem] text-orange-600 font-semibold mb-6'>
                    About Us
                </h2>
            ...
            <div className='w-full md:w-1/2'>
                <div className='grid grid-cols-2 grid-rows-2 '>
                    ...
                    <img src={IMG9} alt='Team Image 3' className='w-full h-40 md:h-48 lg:h-70 object-cover rounded-lg transform rotate-6 border-4  border-orange-500' />
                    <img src={IMG8} alt='Team Image 4' className='w-full h-40 md:h-48 lg:h-70 object-cover rounded-lg transform -rotate-6 border-4  border-orange-500' />
                </div>
            </div>
        </div>
    );
